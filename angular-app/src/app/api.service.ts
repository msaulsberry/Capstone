...
export class ApiService {
  private expressApiUrl = 'http://57.151.31.172:3000/api/grades'; // Adjust the URL as necessary
  private flaskApiUrl = 'http://172.171.152.194:5000/api/generate'; // Adjust the URL as necessary
